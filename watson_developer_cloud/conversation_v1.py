...
class DialogNodeOutputOptionsElement(object):
    ...
    def __init__(self, label, value):
        ...
        input to be sent to the Conversation service if the user selects the corresponding
        option.
        """
        self.label = label
        self.value = value
...
class DialogNodeOutputOptionsElementValue(object):
    """
    An object defining the message input to be sent to the Conversation service if the
...
class DialogSuggestion(object):
    ...
    entities to be sent to the Conversation service if the user selects the corresponding
    disambiguation option.
    :attr object output: (optional) The dialog output that will be returned from the
    Conversation service if the user selects the corresponding option.
    """
    ...
    def __init__(self, label, value, output=None):
        ...
        and entities to be sent to the Conversation service if the user selects the
...
class DialogSuggestionValue(object):
    ...
    Conversation service if the user selects the corresponding disambiguation option.
...
class WorkspaceSystemSettings(object):
    ...
    **Note:** This feature is available only to Premium users.
    ...
    def __init__(self,
        ...
        related to the Conversation tool.
